...
public class CollectionsOps {
	...
	/**
	 * Add Pipeline Structure to String.
	 */
	private void pipelineStructure(){
		Arrays.asList("Thangavel","Rajesh","Siddhu")
		.stream().map( s -> "Hello\t"+s)
		.collect(Collectors.toList())
		.forEach(names -> System.out.printf("%s\n", names));
	}
